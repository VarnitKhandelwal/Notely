package com.android.varnit.android_assignment.utils;
...
public abstract class SwipeItem extends ItemTouchHelper.SimpleCallback {
    ...
    public SwipeItem(int dragDirs, int swipeDirs, Context context) {
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder,
        ...
        int xMarkTop = itemView.getTop() + (itemHeight - intrinsicHeight) / 3;
        ...
        c.drawText(getLeftSwipeLable(), xMarkLeft + 40, xMarkTop + 140, paint);
